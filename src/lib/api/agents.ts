...
const INITIAL_AGENTS: DbAgent[] = [
  {
    ...
    version: "1.0.0",
    category: "TREASURY",
    capabilities: ["PRIVATE_TRANSFER", "POLICY_ENFORCEMENT", "HUMAN_APPROVAL", "EXECUTION_ATTESTATION", "AUDIT_SUPPORT", "SCHEDULED_PAYMENTS", "BUDGET_MANAGEMENT", "BATCH_PAYMENTS", "WORKFLOW_PARTICIPATION", "PAYMENT_REQUESTS"],
  ...
  },
  {
    ...
    version: "0.8.0",
    category: "PAYMENTS",
    capabilities: ["PRIVATE_TRANSFER", "POLICY_ENFORCEMENT", "HUMAN_APPROVAL", "WORKFLOW_PARTICIPATION", "PAYMENT_REQUESTS", "SCHEDULED_PAYMENTS"],
  ...
  },
  {
    ...
    version: "0.2.0",
    category: "COMPLIANCE",
    capabilities: ["AUDIT_SUPPORT", "EXECUTION_ATTESTATION", "WORKFLOW_PARTICIPATION", "COMPLIANCE_REVIEW"],
    supportedAssets: ["USDC"],
    riskLevel: "LOW",
